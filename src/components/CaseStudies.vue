...
const ready = computed(() => isVisible.value && dataLoaded.value)
            ...
            <div class="max-w-[1920px] mx-auto">
                ...
                <div class="grid lg:grid-cols-2 gap-6 lg:gap-8">
                    <div v-for="(item, i) in cases" :key="i"
                        ...
                        :style="{ transition: `all 0.7s cubic-bezier(0.16,1,0.3,1) ${0.2 + i * 0.15}s` }">
                        ...
                        <div class="absolute inset-0 bg-gradient-to-t from-primary/80 via-primary/30 to-primary/5 group-hover:from-primary/70 transition-all duration-700"></div>
                        ...
                        <div class="absolute inset-0 flex flex-col justify-end p-8 lg:p-12">
                            ...
                            <div class="border-l-2 border-secondary/60 pl-5 py-1"
                                :class="ready ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'"
                                ...
                                <p class="text-white/70 text-sm sm:text-base font-light leading-relaxed">{{ item.result }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-16 lg:mt-20 text-center"
                    ...
                    <router-link to="/casos-de-exito"
                        class="group inline-flex items-center gap-5 font-label text-[9px] sm:text-[10px] font-bold tracking-[0.25em] uppercase text-secondary hover:text-white transition-colors duration-300 no-underline border border-secondary/20 px-10 py-4 hover:border-white/20">
