...
<template>
    <section ref="el" class="relative bg-white py-24 lg:py-32 px-6 overflow-hidden">
        <div class="w-full h-[2px] bg-secondary/40 absolute top-0 left-0"></div>
        ...
        <div class="container mx-auto max-w-[1400px]">
            <div class="text-center mb-16 lg:mb-20"
                ...
                <p class="text-dark/50 font-light text-base sm:text-lg max-w-2xl mx-auto mt-6">
                    Visión estratégica y respaldo jurídico liderado por profesionales con trayectoria excepcional.
                </p>
            </div>

            <div class="grid md:grid-cols-3 gap-px bg-primary/10">
                <div v-for="(partner, i) in partners" :key="partner.slug"
                    ...
                    <div class="relative overflow-hidden h-[380px] lg:h-[420px]">
                        ...
                        <div class="absolute inset-0 bg-gradient-to-t from-primary/70 via-primary/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                    ...
                    <div class="p-6 lg:p-8 border-t border-primary/5">
                        <p class="font-label text-[8px] tracking-[0.3em] uppercase text-secondary font-bold mb-2">{{ partner.roleLabel }}</p>
                        <h3 class="font-headline text-xl lg:text-2xl text-primary font-bold leading-tight mb-2">{{ partner.nombre }}</h3>
                        <p class="text-dark/50 text-sm font-light mb-6">{{ partner.specialty }}</p>
